...
- **Original document**: `examples/sample_original.docx`
- **Edited document**: `live_verification/live_edited.docx`
- **Generated at**: 2026-08-10T10:09:14+00:00
...
| Internal Cross-References | Document | Cross-reference field count | >= 1 | 0 |
...
| Tracked Changes | Document (Edited) | <w:ins> id=1 | PASS |
...
| Internal Cross-References | Document | Cross-reference field count | FAIL |
| Internal Cross-References | Document | Cross-reference target resolution | PASS |
